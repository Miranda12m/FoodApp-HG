...
function ProductScreen() {
  ...
  const soupOptions = [
    { label: "Option 1", image: "/images/soup01.jpg" }, {/* Here replace*/},
    { label: "Option 2", image: "/images/soup02.jpg" }, {/* Here replace*/},
  ];

  const mainFoodOptions = [
    { label: "Main Food Option 1", image: "/images/main01.jpg" }, {/* Here replace*/},
    { label: "Main Food Option 2", image: "/images/main02.jpg" }, {/* Here replace*/},
  ];
  ...
  const waterOptions = [
    { label: "Water Option 1", value: "water-1" }, {/* Here replace*/},
    { label: "Water Option 2", value: "water-2" }, {/* Here replace*/},
  ];
            ...
            <Card.Body>
              ...
              <Form>
                ...
                <Form.Group controlId="formWantIceCream">
                  <Form.Check
                    type="checkbox"
                    label={`Do you want {ice cream of the day}?`} // Here replace 
                  ...
                  {wantIceCream && (
                    <div style={{ padding: "10px 0" }}>
                      ...
                      <img src="/images/cream01.jpg" alt="Ice Cream" style={{ width: "125px", height: "auto" }} /> {/* Here replace*/}
                    </div>
                  )}
                </Form.Group>
                {/* Soup Checkbox */}
                <Form.Group controlId="formWantSoup">
                  <Form.Check
                    type="checkbox"
                    label="Do you want soup?" // {/* Here replace*/}
                    checked={wantSoup}
